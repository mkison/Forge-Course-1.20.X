...
public enum ModArmorMaterials implements ArmorMaterial {
    ALEXANDRITE("alexandrite", 24, (EnumMap)Util.make(new EnumMap(ArmorItem.Type.class), (enumMap) -> {
        enumMap.put(ArmorItem.Type.BOOTS, 4);
        enumMap.put(ArmorItem.Type.LEGGINGS, 6);
        enumMap.put(ArmorItem.Type.CHESTPLATE, 9);
        enumMap.put(ArmorItem.Type.HELMET, 4);
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.5F, () -> Ingredient.of(ModItems.ALEXANDRITE.get()));
    ...
    private ModArmorMaterials(String name, int pDurabilityMultiplier, EnumMap <ArmorItem.Type, Integer> protectionTypeMap, int EnchantmentValue, SoundEvent soundEvent, float toughness, float knockbackRes, Supplier repairMaterial) {
        this.name = name;
